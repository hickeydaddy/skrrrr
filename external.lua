...
function Module.BuildAllUI(Rayfield, Window, me, folderName, sendRequest, isVersionSafe, SAFE_PLACE_VERSION, currentVersion, UI_THEMES, selectedDisplayTheme)
    ...
    local Dropdown_Upgrades = MainTab:CreateDropdown({Name = "Select Currencies to Auto-Upgrade", Options = {"Coins", "PP", "AP", "Stars", "TP", "Time", "Energy", "Crystals", "Clicks", "Jade", "Essence", "Rarities", "Crowns"}, CurrentOption = {"Coins"}, MultipleOptions = true, Callback = function(O) _G.AutoUpgradesList = O end})
