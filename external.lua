...
function Module.BuildAllUI(Rayfield, Window, me, folderName, sendRequest, isVersionSafe, SAFE_PLACE_VERSION, currentVersion, UI_THEMES, selectedDisplayTheme)
    ...
    AboutTab:CreateParagraph({Title = "<font size=\"16\"><b>[*] Update: 6/11/2026</b></font>", Content = "• Replaced Heartbeat os.clock() timers with Task Scheduler loops to prevent anti-cheat rate-limit kicks during lag spikes."})
