...
function Module.BuildAllUI(Rayfield, Window, me, folderName, sendRequest, isVersionSafe, SAFE_PLACE_VERSION, currentVersion, UI_THEMES, selectedDisplayTheme)
    ...
    AboutTab:CreateParagraph({Title = "<font size=\"16\"><b>[*] Update: 6/11/2026</b></font>", Content = "• Added Startup Jitter to prevent instant packet-burst kicks upon config auto-load.\n• Implemented absolute millisecond targeting for highly stable execution.\n• Corrected Quirk Auto-Roll timings to safely bypass rate-limit buckets."})
