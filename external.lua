...
function Module.BuildAllUI(Rayfield, Window, me, folderName, sendRequest, isVersionSafe, SAFE_PLACE_VERSION, currentVersion, UI_THEMES, selectedDisplayTheme)
    ...
    AboutTab:CreateParagraph({Title = "<font size=\"16\"><b>[*] Update: 5/27/2026</b></font>", Content = "• Added Safe & Fast Auto Rollers for Yatzy.\n• Added Safe & Fast Auto Rollers for Coin Flip.\n• Added Cash and Silver to Auto-Upgrades.\n• Config system dynamically handles all new automations."})
    ...
    MainTab:CreateParagraph({Title = "⚠️ FPS Booster Note", Content = "Restart Required: You might need to rejoin after enabling/disabling the Rolling Frame Disabler for it to work properly. Save this in your autoload!"})
    local Toggle_RollingFrame = MainTab:CreateToggle({Name = "Disable Rolling Frame (Boost FPS by A LOT)", CurrentValue = false, Callback = function(V) _G.DisableRollingFrameActive = V end})
    ...
    -- YATZY ROLLS
    local Toggle_SafeYatzy, Toggle_FastYatzy
    Toggle_SafeYatzy = MainTab:CreateToggle({Name = "Safe Fast Yatzy Auto Roll", CurrentValue = false, Callback = function(V) if _G.YatzyNetworkLock and V then task.spawn(function() pcall(function() Toggle_SafeYatzy:Set(false) end) end); return end; _G.SafeYatzyRollActive = V; if V and _G.FastYatzyRollActive then _G.YatzyNetworkLock = true; _G.FastYatzyRollActive = false; task.spawn(function() pcall(function() Toggle_FastYatzy:Set(false) end) end); task.wait(math.random(1400, 1600) / 1000); _G.YatzyNetworkLock = false end end})
    Toggle_FastYatzy = MainTab:CreateToggle({Name = "Fast Yatzy Auto Roll", CurrentValue = false, Callback = function(V) if _G.YatzyNetworkLock and V then task.spawn(function() pcall(function() Toggle_FastYatzy:Set(false) end) end); return end; _G.FastYatzyRollActive = V; if V and _G.SafeYatzyRollActive then _G.YatzyNetworkLock = true; _G.SafeYatzyRollActive = false; task.spawn(function() pcall(function() Toggle_SafeYatzy:Set(false) end) end); task.wait(math.random(1400, 1600) / 1000); _G.YatzyNetworkLock = false end end})

    -- COIN FLIP ROLLS
    local Toggle_SafeCoinFlip, Toggle_FastCoinFlip
    Toggle_SafeCoinFlip = MainTab:CreateToggle({Name = "Safe Fast Auto Coin Flip", CurrentValue = false, Callback = function(V) if _G.CoinFlipNetworkLock and V then task.spawn(function() pcall(function() Toggle_SafeCoinFlip:Set(false) end) end); return end; _G.SafeCoinFlipActive = V; if V and _G.FastCoinFlipActive then _G.CoinFlipNetworkLock = true; _G.FastCoinFlipActive = false; task.spawn(function() pcall(function() Toggle_FastCoinFlip:Set(false) end) end); task.wait(math.random(1400, 1600) / 1000); _G.CoinFlipNetworkLock = false end end})
    Toggle_FastCoinFlip = MainTab:CreateToggle({Name = "Fast Auto Coin Flip", CurrentValue = false, Callback = function(V) if _G.CoinFlipNetworkLock and V then task.spawn(function() pcall(function() Toggle_FastCoinFlip:Set(false) end) end); return end; _G.FastCoinFlipActive = V; if V and _G.SafeCoinFlipActive then _G.CoinFlipNetworkLock = true; _G.SafeCoinFlipActive = false; task.spawn(function() pcall(function() Toggle_SafeCoinFlip:Set(false) end) end); task.wait(math.random(1400, 1600) / 1000); _G.CoinFlipNetworkLock = false end end})
