...
function Module.BuildAllUI(Rayfield, Window, me, folderName, sendRequest, isVersionSafe, SAFE_PLACE_VERSION, currentVersion, UI_THEMES, selectedDisplayTheme)
    ...
    AboutTab:CreateParagraph({Title = "<font size=\"16\"><b>[*] Update: 5/27/2026</b></font>", Content = "• Added Fast Auto Rollers for Yatzy & Coin Flip.\n• Removed redundant Safe rollers since fast versions are completely safe.\n• Added Cash and Silver to Auto-Upgrades."})
